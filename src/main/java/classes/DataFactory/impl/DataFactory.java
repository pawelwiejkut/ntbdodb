 ...
 * www.andygibson.net
 *
 * This file is part of classes.DataFactory.
 *
...
import classes.DataFactory.AddressDataValues;
import classes.DataFactory.ContentDataValues;
import classes.DataFactory.NameDataValues;
...
public class DataFactory {
   ...
   *
   * <pre>
   * dataFactory = classes.DataFactory create();
   * or
   * dataFactory = classes.DataFactory create(5765297);
   * or
   * dataFactory = classes.DataFactory create(someRandom);
   * </pre>
   *
   *
   ...
   *
   * <pre>
   * classes.DataFactory createWithOriginalRandom();
   * </pre>
   *
   ...
   *
   * @return classes.DataFactory instance with a shared random
   */
   ...
   *
   * <pre>
   * if (classes.DataFactory.chance(70)) {
